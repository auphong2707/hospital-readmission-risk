...
# Import the mapping file from data-api directory or project root
sys.path.append(str(Path(__file__).parent.parent))  # Add data-api to path
sys.path.append(str(Path(__file__).parent.parent.parent.parent))  # Add project root to path
try:
    from file_to_hf_repo_mapping import REPO_MAPPING, get_download_info
except ImportError:
    print("Warning: file_to_hf_repo_mapping.py not found")
    REPO_MAPPING = {}
