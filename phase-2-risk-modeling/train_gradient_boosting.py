"""Orchestrator to run preprocessing (optional) and train the LightGBM model.
...
- invoke `lightgbm_model.py` with sensible defaults or forwarded args

Usage (from repository root):
    python phase-2-risk-modeling/train_gradient_boosting.py

Example:
    python phase-2-risk-modeling/train_gradient_boosting.py --skip-preprocess --skip-search --n-jobs 4
"""
...
def main():
    ...
    parser.add_argument("--trainer-script", type=str, default="phase-2-risk-modeling/lightgbm_model.py", help="Trainer script path")
