...
Kaggle usage:
    !python phase-2-risk-modeling/train_gradient_boosting.py --skip-search --verbose
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Train gradient boosting model for readmission risk.",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Fast training with default params (good for quick testing)
  python train_gradient_boosting.py --fast-mode --verbose
  
  # Full hyperparameter search
  python train_gradient_boosting.py --n-iter 50 --cv 5
  
  # Kaggle optimized (fast CV, use all cores)
  python train_gradient_boosting.py --skip-search --n-jobs -1 --use-gpu
  
  # Custom params from file
  python train_gradient_boosting.py --params-file params.json --skip-search
        """
    )
