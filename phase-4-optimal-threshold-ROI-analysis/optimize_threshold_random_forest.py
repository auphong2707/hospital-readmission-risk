"""
Phase 4: Optimal Threshold & ROI Analysis for Random Forest Model
...
Phase 3 Output Required:
    ...
    - Files: random_forest_model_original.joblib, Random_Forest_calibrator.pkl
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description='Phase 4: Optimal Threshold & ROI Analysis - Random Forest'
    )
    ...
    parser.add_argument(
        '--output-dir',
        type=str,
        default='./phase-4-optimal-threshold-ROI-analysis/outputs_random_forest',
        help='Output directory for results'
    )
    parser.add_argument(
        '--viz-dir',
        type=str,
        default='./phase-4-optimal-threshold-ROI-analysis/visualizations_random_forest',
...
def main():
    ...
    print("\n" + "="*80)
    print("PHASE 4: OPTIMAL THRESHOLD & ROI ANALYSIS - RANDOM FOREST")
    ...
    try:
        ...
        print("   python ./phase-3-model-calibration/calibrate_random_forest.py")
    ...
    results_repo_id = 'auphong2707/hospital-readmission-random-forest-threshold-results'
    ...
    print(f"      python ./phase-5-fairness-evaluation/evaluate_fairness_random_forest.py")
