...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        help='HuggingFace repository ID for Phase 1 data'
    )
    parser.add_argument(
        '--model-repo-id',
        type=str,
    ...
    parser.add_argument(
        '--output-dir',
        type=str,
        default='./phase-4-optimal-threshold-ROI-analysis/outputs/logistic_regression',
        help='Output directory for results'
    )
    parser.add_argument(
        '--viz-dir',
        type=str,
        default='./phase-4-optimal-threshold-ROI-analysis/visualizations/logistic_regression',
...
def load_logistic_regression_calibrated(model_repo_id, cache_dir, force_download):
    """
    ...
    # Try loading from local calibration outputs first
    local_calib_dir = Path("./calibration_outputs/logistic_regression")
    ...
    if local_calib_dir.exists() and not force_download:
        ...
        calibrator_path = local_calib_dir / "Logistic_Regression_calibrator.pkl"
    ...
    try:
        ...
        print("Please ensure Phase 3 calibration has been run:")
        print("   python ./phase-3-model-calibration/calibrate_logistic_regression.py")
        sys.exit(1)
    except ImportError:
...
def main():
    ...
    print("Hospital Readmission Risk Prediction - Logistic Regression")
    print("="*80)
    ...
    results_repo_id = 'auphong2707/hospital-readmission-lr-threshold-optimized'
